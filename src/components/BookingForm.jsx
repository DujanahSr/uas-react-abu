...
import { AiOutlineCalendar, AiOutlineUser, AiOutlineSwap, AiOutlineSetting } from 'react-icons/ai';
...
const BookingForm = ({ onSearch }) => {
  ...
  return (
    <div className="p-6 mb-6 transition-colors bg-white border border-gray-200 shadow-lg dark:bg-gray-800 rounded-xl dark:border-gray-700">
      <h2 className="mb-6 text-xl font-bold text-gray-800 dark:text-white">Cari Penerbangan</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="relative">
            <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Dari</label>
            <div className="relative">
              <AiOutlineSetting className="absolute text-gray-400 left-3 top-3 dark:text-gray-500" />
              <select
                name="from"
                value={formData.from}
                onChange={handleChange}
          ...
          <div className="flex items-end">
            ...
            >
              <AiOutlineSwap size={20} className="text-gray-600 dark:text-gray-300" />
            </button>
          </div>

          {/* To */}
          <div>
            <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Ke</label>
            <div className="relative">
              <AiOutlineSetting className="absolute text-gray-400 left-3 top-3 dark:text-gray-500" />
              <select
                name="to"
          ...
          {/* Passengers */}
          <div>
            <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Penumpang</label>
            <div className="relative">
          ...
          {/* Departure Date */}
          <div>
            <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Berangkat</label>
            <div className="relative">
          ...
          {formData.tripType === 'round-trip' && (
            <div>
              <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Kembali</label>
              <div className="relative">
                <AiOutlineCalendar className="absolute text-gray-400 left-3 top-3 dark:text-gray-500" />
                <input
                  type="date"
        ...
        <div className="mt-6">
          <button 
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            🔍 Cari Penerbangan
          </button>
        </div>
