...
// const Sidebar = ({ adminData, onLogout }) => {
...
//     { path: '/', icon: <AiOutlineDashboard size={22} />, label: 'Home' },
//     { path: '/search', icon: <AiOutlineSearch size={20} />, label: 'Cari Tiket' },
//     { path: '/my-bookings', icon: <AiOutlineCalendar size={20} />, label: 'Riwayat Booking' },
//     { path: '/profile', icon: <AiOutlineUser size={20} />, label: 'Profil' },
//   ] : [
//     { path: '/admin', icon: <AiOutlineDashboard size={22} />, label: 'Dashboard' },
//     { path: '/admin/flights', icon: <FaPlaneDeparture size={20} />, label: 'Penerbangan' },
//     { path: '/admin/bookings', icon: <AiOutlineCalendar size={20} />, label: 'Pemesanan' },
//     { path: '/admin/analytics', icon: <AiOutlineBarChart size={20} />, label: 'Analitik' },
//     { path: '/admin/settings', icon: <AiOutlineSetting size={20} />, label: 'Pengaturan' },
//   ];

//   // const menuItems = [
//   //   { path: '/', icon: <AiOutlineDashboard size={22} />, label: 'Dashboard' },
//   //   { path: '/flights', icon: <FaPlaneDeparture size={20} />, label: 'Penerbangan' },
//   //   { path: '/bookings', icon: <AiOutlineCalendar size={20} />, label: 'Pemesanan' },
//   //   { path: '/analytics', icon: <AiOutlineBarChart size={20} />, label: 'Analitik' },
//   //   { path: '/settings', icon: <AiOutlineSetting size={20} />, label: 'Pengaturan' },
//   // ];
...
//   // Get content classes based on sidebar state
...
//       <button
//         className="fixed z-50 p-2 text-white transition-all duration-300 transform rounded-full shadow-lg lg:hidden top-4 left-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:shadow-xl hover:scale-105"
//         onClick={() => setIsOpen(!isOpen)}
//         aria-label={isOpen ? "Close menu" : "Open menu"}
//       >
//         {isOpen ? (
//           <AiOutlineClose size={24} className="animate-spin-in" />
//         ) : (
//           <AiOutlineMenu size={24} className="animate-pulse" />
//         )}
//       </button>
...
//                 <FaPlaneDeparture size={32} className="text-blue-600 dark:text-blue-400 animate-float" />
//                 <div className="absolute inset-0 rounded-full bg-blue-400/20 blur-sm animate-ping-slow" />
//               </div>

//               <div className={`overflow-hidden transition-all duration-500 ${getContentClasses()}`}>
...
//             {adminData && (
//               <div className={`mt-4 p-3 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl border border-blue-100 dark:border-blue-800/30 transition-all duration-500 ${getContentClasses()}`}>
//                 <p className="text-xs font-medium text-blue-700 dark:text-blue-300">
//                   👋 Halo, <strong>{adminData.name}</strong>
//                 </p>
...
//                       }}
//                     >
//                       <div className={`transform transition-transform duration-300 ${isCollapsed && !isHovered ? 'translate-x-1' : ''}`}>
//                         {item.icon}
//                       </div>
//                       <span className={`font-medium whitespace-nowrap transition-all duration-500 ${getContentClasses()} ${
...
//             <div className={`mt-8 p-4 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 transition-all duration-500 ${getContentClasses()}`}>
//               <h3 className="mb-2 text-sm font-semibold text-gray-700 dark:text-gray-300">
//                 Statistik Hari Ini
//               </h3>
//               <div className="space-y-2">
//                 <div className="flex items-center justify-between">
//                   <span className="text-xs text-gray-500 dark:text-gray-400">Pemesanan</span>
//                   <span className="text-sm font-bold text-green-600 dark:text-green-400">24</span>
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <span className="text-xs text-gray-500 dark:text-gray-400">Penerbangan</span>
...
//             {/* Version Info */}
//             <div className={`text-center transition-all duration-500 ${getContentClasses()}`}>
...
//       {/* Add custom animations to your CSS or tailwind.config.js */}
//       <style jsx>{`
//         @keyframes float {
