...
const Sidebar = ({ role = "admin", onLogout }) => {
  ...
  return (
    <>
      ...
      <button
        className="fixed lg:hidden top-3 left-3 z-50 flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-500 rounded-full shadow-lg/70 border border-white/10 transition-all duration-300 hover:shadow-xl hover:scale-105"
